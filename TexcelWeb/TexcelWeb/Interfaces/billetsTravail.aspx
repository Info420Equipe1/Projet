    ...
    <div class="wrap">
        <div id="header">
            <div id="top">
                ...
                <div class="right">
                    <p>
                        <asp:Image ID="imgLogo" runat="server" ImageUrl="../img/logo_texcel.png" />
                    </p>
                </div>
            </div>
        </div>
                ...
                <form runat="server">
                    <div id="StatDiv">
                        <asp:Panel ID="pnlStats" runat="server" GroupingText="Statistiques">
                            ...
                            <asp:Label ID="lblNbrBilletPersonnel" runat="server" Text=""></asp:Label><br />
                            <br />
                        </asp:Panel>
                    </div>
                    <div id="billets">
        ...
        <div id="footer">
            <div class="left">
                <p>
                    Design: <a href="#">Marcel Leblond, Benoit Simard, Sébastien Tremblay, Jérémie Tremblay, Louis-Alexandre Munger</a>
