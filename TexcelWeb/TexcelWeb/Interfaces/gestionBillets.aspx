    ...
    <div class="wrap">
        <div id="header">
            <div id="top">
                ...
                <div class="right">
                    <p>
                        <asp:Image ID="imgLogo" runat="server" ImageUrl="../img/logo_texcel.png" /></p>
                </div>
            </div>
        </div>
                        ...
                        <div class="div_1">
                            <div id="div_1a">
                                ...
                                <div class="lblInfo">
                                    ...
                                    <asp:DropDownList runat="server" ID="ddlEquipe" CssClass="txtColum1" AutoPostBack="true" Style="width: 250px" Enabled="False" OnSelectedIndexChanged="ddlEquipe_SelectedIndexChanged" />
                                    <br />
                                    <br />
                                </div>
                                <div class="lblInfo">
        ...
        <div id="footer">
            <div class="left">
                <p>Design: <a href="#">Marcel Leblond, Benoit Simard, Sébastien Tremblay, Jérémie Tremblay, Louis-Alexandre Munger</a>
                    <!--| Admin Panel: <a href=""></a> -->
                </p>
            </div>
        </div>
    </div>
