...
<link rel="stylesheet" type="text/css" href="../css/renouvPassword.css" media="screen" />
</head>
<body>
<div class="wrap">
	<div id="content">
		<div id="main">
            <div>
                <p class="text">Vous avez été redirigé vers cette page car le mot de passe de votre compte utilisateur est expiré.</p><br />
                <p class="text">Pour des raisons de sécurité, veuillez inscrire un nouveau mot de passe dans l'espace réservé à cet effet.</p><br />
            </div>
			<div class="full_w">
				<form runat="server" action="#" method="post">
					<label for="login">Mot de passe:</label>
                    <asp:TextBox ID="txtMotPasse" onpaste="return false;" oncopy="return false" oncut="return false" runat="server" TextMode="Password"></asp:TextBox>
                    ...
                    <asp:TextBox ID="txtMotPasse2" onpaste="return false;" oncopy="return false" oncut="return false" runat="server" TextMode="Password"></asp:TextBox>
